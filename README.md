Wanb project Link: https://wandb.ai/sarah-mdr-/nyc_airbnb?nw=nwusersarahmdr
GitHub project Link: https://github.com/Sarah-MDR/build-ml-pipeline-for-short-term-rental-prices
...
```
git clone https://github.com/Sarah-MDR/build-ml-pipeline-for-short-term-rental-prices.git
```
